...
public class ClampManager : MonoBehaviour 
{
    ...
    public void OnApplicationQuit()
    {
        if (saveDryTime && GameManager.instance != null)
        {
            ...
            PlayerPrefs.SetFloat(GameManager.instance.ScoreKey, GameManager.instance.scoreTracker.ScorePercentage);
            PlayerPrefs.SetFloat(GameManager.instance.StepsKey, GameManager.instance.scoreTracker.NumberOfSteps);
            PlayerPrefs.Save();
        }
    }
}